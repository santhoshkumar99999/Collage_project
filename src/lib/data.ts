...
const quizzes: Quiz[] = [
  {
    ...
    questions: [
      { id: 'q1', question: 'You buy 3 pens that cost \'p\' rupees each and a notebook for 20 rupees. The total cost is 50 rupees. What is the cost of one pen?', options: ['5 rupees', '10 rupees', '15 rupees', '20 rupees'], correctAnswer: '10 rupees', hint: 'Set up the equation: 3p + 20 = 50. First, subtract 20 from both sides.' },
      ...
      { id: 'q3', question: 'You are saving for a bicycle that costs 2000 rupees. You already have 500 rupees. If you save \'s\' rupees each week for 10 weeks, how much must you save each week?', options: ['100 rupees', '150 rupees', '200 rupees', '250 rupees'], correctAnswer: '150 rupees', hint: 'You need to save 2000 - 500 = 1500 rupees. The equation is 10s = 1500.' },
      { id: 'q4', question: 'A recipe for 4 people requires 2 cups of flour. How many cups of flour (f) are needed if you want to cook for 10 people?', options: ['3 cups', '4 cups', '5 cups', '6 cups'], correctAnswer: '5 cups', hint: 'First, find out how much flour is needed for one person (2 cups / 4 people). Then multiply by 10.' },
      { id: 'q5', question: 'Your age is \'a\'. Your father is 3 times your age. The sum of your ages is 48. How old are you?', options: ['10', '12', '14', '16'], correctAnswer: '12', hint: 'The equation is a + 3a = 48. Combine the \'a\' terms first.' },
    ],
  },
  {
    id: 'geometry-quiz',
    ...
    questions: [
      ...
      { id: 'q4', question: 'A ladder is leaning against a wall. The base is 3 meters from the wall, and it reaches 4 meters up the wall. What is the length of the ladder?', options: ['4 meters', '5 meters', '6 meters', '7 meters'], correctAnswer: '5 meters', hint: 'Use the Pythagorean theorem: a² + b² = c², where c is the ladder\'s length.' },
      { id: 'q5', question: 'You have a cylindrical water tank with a radius of 1 meter and a height of 2 meters. What is its volume? (Use π ≈ 3.14)', options: ['3.14 m³', '6.28 m³', '9.42 m³', '12.56 m³'], correctAnswer: '6.28 m³', hint: 'Volume of a cylinder is π * radius² * height.' },
    ],
  },
   {
    ...
    questions: [
      ...
      { id: 'q3', question: 'If you put a plastic bag over a plant leaf in the sun, you might see water droplets inside. This is because plants release water vapor during a process called...?', options: ['Respiration', 'Transpiration', 'Condensation', 'Photosynthesis'], correctAnswer: 'Transpiration', hint: 'This process is like the plant "sweating" and is linked to photosynthesis as water is transported through the plant.' },
      { id: 'q4', question: 'Fruits and vegetables are a source of energy for us. Where did this energy originally come from?', options: ['The soil', 'The rain', 'The sun', 'The air'], correctAnswer: 'The sun', hint: 'Plants store energy from the sun as sugars through photosynthesis, which we then eat.' },
      { id: 'q5', question: 'If a large forest is cut down, what is a likely effect on the atmosphere in that area?', options: ['Oxygen levels will increase', 'Carbon Dioxide levels will increase', 'Nitrogen levels will decrease', 'It will get colder'], correctAnswer: 'Carbon Dioxide levels will increase', hint: 'Fewer trees mean less CO2 is being removed from the atmosphere for photosynthesis.' },
    ],
  },
  {
    ...
    questions: [
        ...
        { id: 'q2', question: 'It is harder to push a heavy box than a light one. This is an example of which law?', options: ['First Law', 'Second Law (F=ma)', 'Third Law', 'Law of Gravity'], correctAnswer: 'Second Law (F=ma)', hint: 'The heavy box has more mass, so it requires more force to achieve the same acceleration.' },
        ...
        { id: 'q4', question: 'Why does a ball thrown in the air eventually fall back to Earth?', options: ['It runs out of energy', 'A force called gravity pulls it down', 'Air resistance stops it', 'Newton\'s First Law'], correctAnswer: 'A force called gravity pulls it down', hint: 'An object in motion stays in motion unless an external force acts on it. Gravity is that force.'},
        { id: 'q5', question: 'To make a car go faster (accelerate), what must the engine do?', options: ['Decrease the mass', 'Increase the force', 'Reduce the friction', 'Increase the weight'], correctAnswer: 'Increase the force', hint: 'Think about F=ma. To increase \'a\' (acceleration) while \'m\' (mass) is constant, you must increase \'F\' (force).'},
    ],
  },
  {
    ...
    questions: [
        { id: 'q1', question: 'After you eat food, which part of your cells works to convert the sugar from that food into usable energy (ATP)?', options: ['Nucleus', 'Ribosome', 'Mitochondria', 'Cell Membrane'], correctAnswer: 'Mitochondria', hint: 'This organelle is known as the "powerhouse" of the cell for a reason.' },
        { id: 'q2', question: 'Your body needs to create proteins to build muscle and repair tissues. Which tiny "factories" in your cells are responsible for building proteins?', options: ['Lysosomes', 'Vacuoles', 'Ribosomes', 'Golgi apparatus'], correctAnswer: 'Ribosomes', hint: 'These organelles follow instructions from the DNA to assemble proteins.' },
        ...
        { id: 'q5', question: 'When you get sick from a virus, the virus must get inside your cells to replicate. What part of the cell does it have to cross first?', options: ['Nucleus', 'Mitochondria', 'Cell Wall', 'Cell Membrane'], correctAnswer: 'Cell Membrane', hint: 'This is the outer boundary of an animal cell that controls what goes in and out.' },
    ],
  },
  {
    ...
    questions: [
      { id: 'q1', question: 'If a mother has blue eyes (bb) and a father has brown eyes (BB), what is the most likely eye color of their child?', options: ['Blue', 'Brown', 'Green', 'A mix of blue and brown'], correctAnswer: 'Brown', hint: 'Brown eyes (B) are dominant over blue eyes (b). The child will inherit one allele from each parent (Bb).' },
      ...
      { id: 'q3', question: 'DNA testing can be used to identify people. This is possible because...', options: ['Everyone has the same DNA', 'Each person (except identical twins) has a unique DNA sequence', 'DNA changes every day', 'DNA is only in our blood'], correctAnswer: 'Each person (except identical twins) has a unique DNA sequence', hint: 'While most of our DNA is the same, small variations make each of us genetically unique.' },
      { id: 'q4', question: 'Some farmers breed cows that produce more milk. This is an example of using genetics for...', options: ['Natural selection', 'Artificial selection (selective breeding)', 'Random mutation', 'Cloning'], correctAnswer: 'Artificial selection (selective breeding)', hint: 'Humans are choosing which animals reproduce based on desirable traits, which is a core concept in agriculture.' },
      { id: 'q5', question: 'If you have a trait for straight hair (recessive) but both your parents have curly hair (dominant), what must be true about your parents\' genes?', options: ['They both have only curly hair genes', 'They both carry the straight hair gene', 'One parent has only straight hair genes', 'It is impossible'], correctAnswer: 'They both carry the straight hair gene', hint: 'For you to have the recessive trait, you must have received a recessive allele from both parents. This means they are both heterozygous (e.g., Cc).' },
    ],
  },
  {
    id: 'ml-intro-quiz',
    ...
    questions: [
        ...
        { id: 'q4', question: 'A self-driving car learns to stay in its lane by getting "rewards" for driving well and "penalties" for errors. This is an example of...?', options: ['Supervised Learning', 'Unsupervised Learning', 'Reinforcement Learning', 'Manual Driving'], correctAnswer: 'Reinforcement Learning', hint: 'This type of learning is based on trial and error, rewards, and punishments to achieve a goal.' },
        { id: 'q5', question: 'To train a machine learning model to recognize cats in photos, what do you need most?', options: ['A very fast computer', 'A large dataset of labeled photos (cats and not-cats)', 'A good internet connection', 'One perfect photo of a cat'], correctAnswer: 'A large dataset of labeled photos (cats and not-cats)', hint: 'Machine learning models learn from data. The more data they have, the better they usually become.' },
    ],
  },
  {
